...
const navigation = [
    { name: 'Detergenti rufe', href: '#', current: true },
    { name: 'Balsam rufe', href: '#', current: false },
    { name: 'Degresanti', href: '#', current: false },
    { name: 'Produse curatenie', href: '#', current: false },
    { name: 'Ingrijire personala', href: '#', current: false },
    { name: 'Accesorii curatenie', href: '#', current: false },
]
